...
np.savetxt('simulation_functions/saved_data/sync_noise/chi_HH_noise.txt',chi_HH_k)
np.savetxt('simulation_functions/saved_data/sync_noise/chi_IF_noise.txt',chi_IF_k)
np.savetxt('simulation_functions/saved_data/sync_noise/chi_IZH_noise.txt',chi_IZH_k)
np.savetxt('simulation_functions/saved_data/sync_noise/chi_ML_noise.txt',chi_ML_k)

np.savetxt('simulation_functions/saved_data/sync_noise/rel_HH_noise.txt',rel_HH_k)
np.savetxt('simulation_functions/saved_data/sync_noise/rel_IF_noise.txt',rel_IF_k)
np.savetxt('simulation_functions/saved_data/sync_noise/rel_IZH_noise.txt',rel_IZH_k)
np.savetxt('simulation_functions/saved_data/sync_noise/rel_ML_niose.txt',rel_ML_k)

np.savetxt('simulation_functions/saved_data/sync_noise/firing_rate_HH_noise.txt',firing_rate_HH_k)
np.savetxt('simulation_functions/saved_data/sync_noise/firing_rate_IF_noise.txt',firing_rate_IF_k)
np.savetxt('simulation_functions/saved_data/sync_noise/firing_rate_IZH_noise.txt',firing_rate_IZH_k)
np.savetxt('simulation_functions/saved_data/sync_noise/firing_rate_ML_noise.txt',firing_rate_ML_k)

np.savetxt('simulation_functions/saved_data/sync_noise/rossum_HH_noise.txt',rossum_HH_k)
np.savetxt('simulation_functions/saved_data/sync_noise/rossum_IF_noise.txt',rossum_IF_k)
np.savetxt('simulation_functions/saved_data/sync_noise/rossum_IZH_noise.txt',rossum_IZH_k)
np.savetxt('simulation_functions/saved_data/sync_noise/rossum_ML_noise.txt',rossum_ML_k)

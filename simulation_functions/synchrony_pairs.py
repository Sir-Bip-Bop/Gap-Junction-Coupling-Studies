...
params_ML = project.utils.load_ML(psi = 0.4, gk = 4, V1 = -1.2, V3 = 2, Eshunt = -60,  Ek = -84, gshunt = 0.2, Ena=85 )
...
np.savetxt('simulation_functions/saved_data/sync_k_newML/chi_HH_k.txt',chi_HH_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/chi_IF_k.txt',chi_IF_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/chi_IZH_k.txt',chi_IZH_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/chi_ML_k.txt',chi_ML_k)

np.savetxt('simulation_functions/saved_data/sync_k_newML/rel_HH_k.txt',rel_HH_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/rel_IF_k.txt',rel_IF_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/rel_IZH_k.txt',rel_IZH_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/rel_ML_k.txt',rel_ML_k)

np.savetxt('simulation_functions/saved_data/sync_k_newML/firing_rate_HH_k.txt',firing_rate_HH_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/firing_rate_IF_k.txt',firing_rate_IF_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/firing_rate_IZH_k.txt',firing_rate_IZH_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/firing_rate_ML_k.txt',firing_rate_ML_k)

np.savetxt('simulation_functions/saved_data/sync_k_newML/rossum_HH_k.txt',rossum_HH_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/rossum_IF_k.txt',rossum_IF_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/rossum_IZH_k.txt',rossum_IZH_k)
np.savetxt('simulation_functions/saved_data/sync_k_newML/rossum_ML_k.txt',rossum_ML_k)

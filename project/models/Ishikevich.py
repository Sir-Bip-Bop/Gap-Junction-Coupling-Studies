...
def rk_ish_scale_synaptic(dt,t_final,order,y0,u0,I,Isyn,C,vr,vt,k_2,a,b,c,d,vpeak,k_u,strength,tau):
    '''
    Runge-Kutta integration of the 4th order of the Izhikevich model
    '''
...
def rk_ish_2_scale_synaptic(dt,t_final,order,y0,u0,I,Isyn,C,vr,vt,k_2,a,b,c,d,vpeak,k_u,strength,tau,E_matrix,C_matrix,return_dict):
    '''
    Runge-Kutta integration of the 4th order of the Izhikevich model
    '''
